...
library("lmgeom")
setwd("/CONI_Isotope/")
cm_data<-read_excel("Data/CMinorIsotopeData.xlsx") ## Read in excel file with data, using the Geo-referenced Coordinates for the following calculations
...
coastline<-read_sf("Shapefiles/GSHHS_i_L1.shp")
sf_use_s2(FALSE) 
...
write.xlsx(cm_data_out,"~/CONI_Isotope/Data/CMinorIsotopeData_withCoastlineDistance.xlsx",row.names=F)
