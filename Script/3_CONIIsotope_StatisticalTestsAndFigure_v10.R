...
interactionplot<-interact_plot(interactioneffectmodel,
                               ...
                               interval = TRUE, 
                               plot.points = TRUE,
                               colors = c("lightgray","black", "darkgray"),
...
interactionplot + scale_linetype_manual(values = c("dashed", "solid", "dotted"), guide = "none")
...
interactionplot2<-interact_plot(interactioneffectmodel2,
                               ...
                               plot.points = TRUE,
                               colors = c("lightgray","black", "darkgray"),
                               legend.main = "Log Coastline Distance",
                               vary.lty= TRUE) +  
  ggplot2::theme_bw() +
  labs(x = "Mean Precipitation",
       y = expression(delta^13 * C * " (" * "\u2030" * ")"))

interactionplot2 + scale_linetype_manual(values = c("dashed", "solid", "dotted"), guide = "none")
